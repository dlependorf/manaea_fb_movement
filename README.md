...
Sean Manaea had a rough beginning to the 2020 season, and there has been
a lot of talk lately around his fastball velocity and how it seems to
track closely with how well he pitches. A pitcher’s velocity is
definitely important, but I don’t think the conversation on Manaea has
hinged around the right thing. Instead of his fastball’s velocity, we
should be talking more about his fastball’s movement.

If you want to follow along, all of the R code needed to collect,
transform, analyze, and plot the data (and even build this post\!) is in
the [R Markdown file in the GitHub repository attached to this
...
able to find this reflected in his how his fastball behaved across those
years.
...
baseballr::scrape\_statcast\_savant() function to grab the data I need.
...
horizontal movement, and vertical movement, found in the
...
if you want to play with the data without pulling it all yourself.

## What did Sean look like before 2020?

A quick pitch movement explainer/refresher: fastballs come out of a
...
10 inches of vertical upward movement isn’t enough to fully counteract
how much a ball falls due to gravity, but it’s enough to make it fall
...
having surgery after the 2018 season, and this absolutely lines up with
how his fastball behaved: the pitch lost around a tick of velocity each
year, and it also lost a few inches of movement in both directions while
he was pitching through pain.
...
I used that point to split up his season. A lot has been made about a
bump in velocity, but aside from the one start on September 5th after a
long COVID-fueled break, there really hasn’t been much in the way of
...
movement is why I chose to split up his season into his first four
starts and then his next five.
...
I don’t know how well Sean will pitch moving forward in 2020, but the
movement on his fastball is absolutely something to keep a close eye on.
This doesn’t mean that velocity isn’t important, but there are other
ways to get outs than pure speed. Sean’s path forward from shoulder
surgery may lie in spin and movement instead.
